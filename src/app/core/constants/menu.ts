  ...
  public static pages: MenuItem[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          route: '/parametarge',
          children: [
            { label: 'Devises ', route: '/parametage/devise' },
            { label: 'List des fournisseurs ', route: '/parametage/fournissuer' },
            { label: 'List des clients ', route: '/parametage/client' },
            { label: 'List des regions ', route: '/parametage/regions' },
            { label: 'List des magasins ', route: '/parametage/magasin' },
          ],
        },
      ],
    },
